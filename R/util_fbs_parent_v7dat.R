...
#' p_v7_dat <- util_fbs_parent_v7dat('2021-10-11')
#'
#' \dontrun{
...
#' p_v7_dat <- util_fbs_parent_v7dat('2021_10_11')
#' }
#'
#'
#' @export
#'
util_fbs_parent_v7dat <- function(date_str, data_path) {
    ...
    if (isTRUE(datestr_arg) & !is.character(date_str)) {
        stop("data_str must be entered as a string: e.g., '2021_10_11'")
