#' util_child_v3dat_home: Process raw qualtrics visit 3 home data for the child
#'
...
#' ch_v3_dat_home <- util_child_v3dat_home('2021-10-11')
#'
#' \dontrun{
...
#' ch_v3_dat_home <- util_child_v3dat_home('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v3dat_home <- function(date_str, data_path) {
