#' util_parent_v7dat: Process raw Qualtrics visit 7 data for the parent (1-year follow-up)
#'
#' This function loads the .sav raw data file for the parent visit 7 data that was collected via Qualtrics at 1-year follow-up and cleans the data. Cleaning the data involves:
...
#' p_v7_dat <- util_parent_v7dat('2021-10-11')
#'
#' \dontrun{
#' #date must be a string. The following will not run:
#' p_v7_dat <- util_parent_v7dat(2021-10-11)
#'
#' #date must match the file name - for file named 'Parent_V7_021_09_16', the
#' following will not run:
#' p_v7_dat <- util_parent_v7dat('2021_10_11')
#' }
#'
#'
#' @export
#'
util_parent_v7dat <- function(date_str, data_path) {
    ...
    qv7_parent_clean <- qv7_parent_dat[c(1, 11, 15:135, 137:452, 454:533)]

    ## update labels
    qv7_parent_clean_labels <- qv7_parent_labels[c(1, 11, 15:135, 137:452, 454:533)]
    ...
    # general order 1) child information 2) anthro - h/w, puberty,parent measured h/w, PA, sleep, 3) general demographics, 4) Fasting procedure, 5) meal related Q's - ranking, eat out, PSS, feeding strategies, 6) child function - BRIEF; 7) notes

    qv7_parent_clean <- qv7_parent_clean[c(2, 1, 437:439, 124:197, 419:436, 30:31, 513:519, 209:214, 16:29, 32:48, 122:123, 503:512, 49:121, 202:208, 198:201, 215:418, 440:502, 3:15)]

    qv7_parent_clean_labels <- qv7_parent_clean_labels[c(2, 1, 437:439, 124:197, 419:436, 30:31, 513:519, 209:214, 16:29, 32:48, 122:123, 503:512, 49:121, 202:208, 198:201, 215:418, 440:502, 3:15)]
    ...
    parent_anthro_vars <- names(qv7_parent_clean)[107:112]
    ...
    relevel_vars <- names(qv7_parent_clean)[c(21:22, 25:26, 33:34, 37:38, 45:46, 49:50, 57:58, 61:62, 69:70, 73:74, 130, 132:133, 135, 145, 156, 158, 160, 175:176, 242, 248, 254, 260, 266, 272, 278, 284, 290, 296, 302, 308, 314, 320, 327, 332, 338, 344, 350, 356, 362, 368, 374)]
    ...
    qv7_parent_clean[177:218] <- sapply(qv7_parent_clean[177:218], function(x) as.numeric(x))
