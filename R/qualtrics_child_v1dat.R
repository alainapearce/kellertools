...
qualtrics_child_v1dat <- function(date_str, data_path) {
    ...
    # 8) random fixes to factor level names and variable descriptions fix pds value labes
    pds_names <- names(qv1_child_clean)[161:178]
