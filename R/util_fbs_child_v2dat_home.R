...
#' ch_v2_dat_home <- util_fbs_child_v2dat_home('2021-10-11')
#'
#' \dontrun{
...
#' ch_v2_dat_home <- util_fbs_child_v2dat_home('2021_10_11')
#' }
#'
#'
#' @export
#'
util_fbs_child_v2dat_home <- function(date_str, data_path) {
