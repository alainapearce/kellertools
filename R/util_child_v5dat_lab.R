#' util_child_v5dat_lab: Process raw qualtrics visit 5 data collected in the lab for the child
#'
...
#' ch_v5_dat_lab <- util_child_v5dat_lab('2021-10-11')
#'
#' \dontrun{
...
#' ch_v5_dat_lab <- util_child_v5dat_lab('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v5dat_lab <- function(date_str, data_path) {
