#' util_child_v1dat_home: Process raw qualtrics visit 1 home data for the child
#'
...
#' ch_v1_dat_home <- util_child_v1dat_home('2021-10-11')
#'
#' \dontrun{
...
#' ch_v1_dat_home <- util_child_v1dat_home('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v1dat_home <- function(date_str, data_path) {
