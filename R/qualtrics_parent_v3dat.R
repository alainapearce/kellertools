#' qualtrics_parent_v3dat: Process raw Qualtrics visit 3 data for the parent
#'
...
#'
#' @param date_str the date used in the name of the .sav file (e.g., for file 'Parent_v3_2021-10-11.sav',
...
#' @export
#'
qualtrics_parent_v3dat <- function(date_str, data_path) {
    ...
    if (isTRUE(datapath_arg)) {
        qv3_parent_path <- paste0(data_path, "/Parent_V3_", date_str, ".sav")
    } else {
