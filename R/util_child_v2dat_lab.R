#' util_child_v2dat_lab: Process raw qualtrics visit 2 data for the child
#'
...
#' ch_v2_dat_lab <- util_child_v2dat_lab('2021-10-11')
#'
#' \dontrun{
#' #date must be a string. The following will not run:
#' ch_v2_dat_lab <- util_child_v2dat_lab(2021-10-11)
#'
#' #date must match the file name - for file named 'Child_V2_Lab_2021_09_16', the
#' following will not run:
#' ch_v2_dat_lab <- util_child_v2dat_lab('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v2dat_lab <- function(date_str, data_path) {
