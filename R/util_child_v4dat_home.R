#' util_child_v4dat_home: Process raw qualtrics visit 4 home data for the child
#'
...
#' ch_v4_dat_home <- util_child_v4dat_home('2021-10-11')
#'
#' \dontrun{
...
#' ch_v4_dat_home <- util_child_v4dat_home('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v4dat_home <- function(date_str, data_path) {
