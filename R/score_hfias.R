...
score_hfias <- function(hfias_data, parID) {
    ...
    hfias_data[["hfias_category"]] <- sjlabelled::add_labels(hfias_data[["hfias_category"]], labels = c(`No Category Fit` = -99, `Severely Food Insecure` = 2, `Moderately Food Insecure` = 2, `Midly Food Insecure` = 1, `Food Secure` = 0))
