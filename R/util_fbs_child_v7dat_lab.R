...
#' ch_v7_dat_lab <- util_fbs_child_v7dat_lab('2021-10-11')
#'
#' \dontrun{
...
#' ch_v7_dat_lab <- util_fbs_child_v7dat_lab('2021_10_11')
#' }
#'
#'
#' @export
#'
util_fbs_child_v7dat_lab <- function(date_str, data_path) {
