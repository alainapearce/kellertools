#' util_child_v7dat: Process raw qualtrics visit 7 data for the child
#'
...
#' ch_v7_dat <- util_child_v7dat('2021-10-11')
#'
#' \dontrun{
...
#' ch_v7_dat <- util_child_v7dat('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v7dat <- function(date_str, data_path) {
