...
#' ch_v2_dat_lab <- util_fbs_child_v2dat_lab('2021-10-11')
#'
#' \dontrun{
...
#' ch_v2_dat_lab <- util_fbs_child_v2dat_lab('2021_10_11')
#' }
#'
#'
#' @export
#'
util_fbs_child_v2dat_lab <- function(date_str, data_path) {
