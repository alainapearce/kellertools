#' util_child_v7dat_home: Process raw qualtrics visit 7 data collected at home for the child
#'
...
#' ch_v7_dat_home <- util_child_v7dat_home('2021-10-11')
#'
#' \dontrun{
...
#' ch_v7_dat_home <- util_child_v7dat_home('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v7dat_home <- function(date_str, data_path) {
