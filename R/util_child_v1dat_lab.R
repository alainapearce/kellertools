#' util_child_v1dat_lab: Process raw qualtrics visit 1 lab data for the child
#'
...
#' ch_v1_dat_lab <- util_child_v1dat_lab('2021-10-11')
#'
#' \dontrun{
...
#' ch_v1_dat_lab <- util_child_v1dat_lab('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v1dat_lab <- function(date_str, data_path) {
