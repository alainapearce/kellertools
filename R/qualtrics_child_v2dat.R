#' qualtrics_child_v2dat: Process raw qualtrics visit 2 data for the child
#'
...
qualtrics_child_v2dat <- function(date_str, data_path) {
    ...
    for (var in 1:length(intake_vars)){
        ...
        qv2_child_clean[[var_name]] <- ifelse(qv2_child_clean[[var_name]] == '-', NA,
                                              ifelse(qv2_child_clean[[var_name]] == '513,63', '513.63', qv2_child_clean[[var_name]]))
