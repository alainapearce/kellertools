#' qualtrics_child_v4dat_home: Process raw qualtrics visit 4 home data for the child
#'
...
#'
#' @param date_str the date used in the name of the .sav file (e.g., for file 'Child_V4_Home_2021-10-11.sav',
...
#' ch_v4_dat <- qualtrics_child_v4dat_home(2021-10-11)
#'
...
#' @export
#'
qualtrics_child_v4dat_home <- function(date_str, data_path) {
    ...
    if (isTRUE(datapath_arg)) {
        qv4_child_path <- paste0(data_path, "/Final_CovidAtHome/Child_V4_Home_", date_str,
            ".sav")
    } else {
    ...
    names(qv4_child_clean) <- c( "id", "start_date", "cwc1", "cwc2", "cwc3", "cwc4", "cwc5",
                                 "cbis_percieved_male", "cbis_ideal_male", "cbis_percieved_female", "cbis_ideal_female",
                                 "psi_responsive_mom1","psi_responsive_mom2","psi_responsive_mom3","psi_responsive_mom4","psi_responsive_mom5",
                                 "psi_responsive_dad1","psi_responsive_dad2","psi_responsive_dad3","psi_responsive_dad4","psi_responsive_dad5")
