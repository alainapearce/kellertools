#' util_child_v2dat: Process raw qualtrics visit 2 data for the child
#'
...
#' ch_v2_dat <- util_child_v2dat('2021-10-11')
#'
#' \dontrun{
...
#' ch_v2_dat <- util_child_v2dat('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v2dat <- function(date_str, data_path) {
