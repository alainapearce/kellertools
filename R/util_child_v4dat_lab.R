#' util_child_v4dat_lab: Process raw qualtrics visit 4 data for the child
#'
...
#' ch_v4_dat_lab <- util_child_v4dat_lab('2021-10-11')
#'
#' \dontrun{
...
#' ch_v4_dat_lab <- util_child_v4dat_lab('2021_10_11')
#' }
#'
#'
#' @export
#'
util_child_v4dat_lab <- function(date_str, data_path) {
