...
#' ch_v3_dat <- util_fbs_child_v3dat('2021-10-11')
#'
#' \dontrun{
...
#' ch_v3_dat <- util_fbs_child_v3dat('2021_10_11')
#' }
#'
#'
#' @export
#'
util_fbs_child_v3dat <- function(date_str, data_path) {
    ...
    if (isTRUE(datapath_arg)) {
        qv3_child_path <- paste0(data_path, "/", "Child_V3_", date_str, ".sav")
    } else {
